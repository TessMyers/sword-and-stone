...
export const continueOptions = ["Continue", "Almost there", "Take the sword", "Play again as a different character"];
...
export const modalTexts = {
  ...
  [modalTypes.HOWTO]: {
    bodyText:
      "Your task is to pull the sword from the stone. You have three tools in your inventory, and each tool can be used in some way to help free the sword. Select a tool, and use your mouse to click on elements in the scene to use the tool on that element. Click around and see what happens! You can't mess up.",
    tip:
      "Turn your sound on; headphones are recommended. Consider using the zoom function to correct for variable screen size. (<b>CMD +/- </b> on Mac or <b>CTRL +/-</b> for a PC)",
    options: []
  },
  [modalTypes.SMALL_SCREEN]: {
    bodyText: "This game is not recommended for small screens. You can try switching to landscape mode and zooming in or out, but you'll probably have a better time on a tablet, laptop, or desktop.",
    options: []
  },
};
...
export const narratives = {
  ...
  [toolTypes.SHOVEl]: {
    bodyText: [
      "As you explore the area, you see the remnants of ancient pipes surrounding the stone, partially buried in soil and wrapped in overgrown greenery. Many passing years have left the plumbing rusty and inoperative.",
  ...
  [toolTypes.LUNCH]: {
    bodyText: [
      "A tree stands to your right, its aged branches gnarled and bare. You recognize the signs of ill-health in the wood, and know with sadness that the venerable tree is dying.",
  ...
  [toolTypes.SHARDS]: {
    bodyText: [
      "Inspecting the stone, you find several deep cracks in the crystalline material. With a steady hand, you carefully slide the crystal shards into place.  As you step back, the stone begins to emit a subtle glow as it becomes whole once more."
    ],
    swordStatus: [
  ...
  [toolTypes.STAFF]: {
    bodyText: [
      "With slow, rhythmic strikes, you beat your holy staff against the earth. Raising your free arm above your head, you reach towards the dark clouds and cry out an invocation to your god. With a thundering crash and the smell of ozone, a blinding branch of lightning snakes down and strikes the crystal stone."
    ],
    swordStatus: [
  ...
  MONK_ENDING: {
    bodyText: [
      "Grasping your staff for support, you slowly raise the weight of the heavy sword. Its pommel shimmers brightly at you, winking in the sun. You peer along the edge, noting areas of rust and corrosion.",
  ...
  KNIGHT_ENDING: {
    bodyText: [
      "You reach out and take the sword, its wrapped hilt cool in your hand. With an experimental swing, you test the heft and balance. Not bad.",
