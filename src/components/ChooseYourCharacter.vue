  ...
  <div class="container">
    ...
    <div class="panels">
      <div
        ...
        v-on:click="beginGame(constants.characters.FARMHAND.name)"
      ></div>
      <div 
        class="panel knight"
        v-on:click="beginGame(constants.characters.KNIGHT.name)"
      ></div>
      <div
        class="panel monk"
        v-on:click="beginGame(constants.characters.MONK.name)"
      ></div>
    </div>
  </div>
</template>
